...
import Controller.AddTeacherController;
 ...
 * @author dell
 */
public class AddTeacherView extends javax.swing.JFrame {

    /**
     * Creates new form Addstu
     */
    private AddTeacherController atc ;
    public AddTeacherView(AddTeacherController atc) {
        this.atc = atc;   
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("TEACHER'S REGISTRATION");
    ...
    private void input_submitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_input_submitActionPerformed
        ...
        try {
          ...
          atc.addSubmit(id,name,sdt,dia_chi);
